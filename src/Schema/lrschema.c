...
static int     $"feedback";                        /*  Feedback for calling program     */

static char     *$"some_param";                     /*  Example of parameter             */
...
static event_t    _LR_stack [$stack_max];             /*  Subdialog call stack             */
static int    _LR_stack_size;                     /*  Subdialog stack size; 0=empty    */
...
:endif
        ...
        for(;;) {
            if ((*_LR_vecptr == _LR_STOP) || ($"exception_raised")) {
                break;
            }
