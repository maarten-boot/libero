/*===========================================================================*
 *                                                                           *
 *  lreval.c    Condition evaluation function 'lr_evaluate ()'               *
 *                                                                           *
...
#include "lrevald.d"                                       /*  Include dialog data              */
...
static byte cmap[256];                                     /*  Character classification maps    */
...
static void get_normal_token(
    void
);
static void get_relator_token(
    void
);
...
#include "lrevald.i"                                       /*  Do dialog manager                */
}
...
)
{
    ...
    } else if (is_relat(thisch)) {
        get_relator_token();
        the_next_event = relator_event;
    } else if (is_quote(thisch)) {
        get_string_token();
...
)
{
    ...
    for (;;) {                                             /*  Loop until string is complete    */
        /*    or end of line                 */
        thisch = condition[column++];
        ...
        } else if (thisch == delim) {
            break;

        } else if (thisch == '\\') {                       /*  Handle escaped character         */
            thisch = condition[column++];
...
MODULE classify_token_as_action(
    void
)
{
    ...
    /*  Table of actions arranged alphabetically for cosmetic purposes                    */
    static ACTION_LOOKUP lookup[] = {
...
MODULE invert_condition_result(
    void
)
{
...
MODULE evaluate_animation_enabled(
    void
)
{
...
MODULE evaluate_defaults_defined(
    void
)
{
...
MODULE evaluate_style_is_cobol(
    void
)
{
...
MODULE evaluate_style_is_headline(
    void
)
{
...
MODULE evaluate_style_is_plain(
    void
)
{
...
MODULE evaluate_style_is_title(
    void
)
{
...
MODULE evaluate_style_is_normal(
    void
)
{
...
MODULE init_left_and_right_expr(
    void
)
{
    strclr(lexpr);
...
MODULE concat_token_to_left_expr(
    void
)
{
...
MODULE concat_token_to_right_expr(
    void
)
{
...
MODULE save_left_expr_position(
    void
)
{
    lposn = token_posn;
...
MODULE save_right_expr_position(
    void
)
{
    rposn = token_posn;
...
MODULE evaluate_numeric_comparison(
    void
)
{
    long lvalue,
     rvalue;                                               /*  Expression results               */
    ...
    if (feedback) {
        ...
        if (feedback) {
            /*  Point to error in right expr     */
            token_posn = rposn + offset;
        }
    }

    if (feedback) {
        /*  If error in expr, signal it      */
        ...
        default:
            signal_error(MSG_EVAL_INTERNAL_ERROR);
        }
    }
}
...
MODULE evaluate_string_comparison(
    void
)
{
    int cmp;
...
MODULE signal_expression_expected(
    void
)
{
...
MODULE signal_expr_or_string_expected(
    void
)
{
...
MODULE signal_relator_expected(
    void
)
{
...
)
{
    ...
    if (feedback) {
        /*  If error, return position of     */
        *offset = token_posn;                              /*    error in expression line       */
    } else if (invert) {
        /*  Else invert result if needed     */
        *result = !*result;
    }
}
