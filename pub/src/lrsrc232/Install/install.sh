...
#----------------------------------------------------------------------------
#
#   install.sh  Rebuilds and installs Libero on UNIX systems
#   Syntax:     Bourne shell
#
#   Written:    95/03/10  Pieter Hintjens
#   Revised:    96/12/26  Pieter Hintjens
#
...
#-  install.sh - generated script; do not modify directly. See install.l
#-  Generated by LIBERO 2.11 on 20 Feb, 1996, 11:45.
#-  Schema used: lrschema.sh
#----------------------------------------------------------------------------
