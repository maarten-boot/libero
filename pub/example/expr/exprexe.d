;----------------------------------------------------------------------------
;   exprexe.d - LIBERO dialog data definitions for exprexe.asm, model=exe.
;   Generated by LIBERO 2.10 on  1 May, 1996, 12:03.
...
;--------------- Main function -----------------------------------------------
                 ...
                 .stack  1024          ; Declare stack segment
                 CODE_SEG
program          label   far
...
LR_mname0        db      'Allow-Signed-Number',0
LR_mname1        db      'Get-Next-Token',0
LR_mname2        db      'Signal-Invalid-Token',0
LR_mname3        db      'Signal-Token-Missing',0
LR_mname4        db      'Stack-The-Number',0
LR_mname5        db      'Stack-The-Operator',0
LR_mname6        db      'Terminate-The-Program',0
LR_mname7        db      'Unstack-All-Operators',0
LR_mname8        db      'Unstack-Ge-Operators',0
LR_mname9        db      'Unstack-If-End-Mark',0
LR_mname10       db      'Unstack-If-Left-Par',0
...
LR_sname0        db      'After-Init',0
LR_sname1        db      'Expecting-Operand',0
LR_sname2        db      'Expecting-Operator',0
LR_sname3        db      'Defaults',0
...
LR_ename0        db      'End-Mark-Event',0
LR_ename1        db      'Error-Event',0
LR_ename2        db      'Exception-Event',0
LR_ename3        db      'Factor-Op-Event',0
LR_ename4        db      'Left-Par-Event',0
LR_ename5        db      'Number-Event',0
LR_ename6        db      'Ok-Event',0
LR_ename7        db      'Other-Event',0
LR_ename8        db      'Right-Par-Event',0
LR_ename9        db      'Term-Op-Event',0
