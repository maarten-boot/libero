;=============================================================================
;
;  exprexe.asm   Expression calculator 'exprexe 1 + 2'
;
...
include exprexe.d                      ; Include dialog definitions
...
get_next_loop:   mov     al,ds:arg_text[bp]
                 inc     bp            ;
...
have_number:     mov     the_next_event,number_event
                 ...
                 xor     ah,ah         ;
next_digit:      mov     cl,ds:arg_text[bp]
                 sub     cl,'0'        ;
