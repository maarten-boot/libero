!============================================================================*
!                                                                            *
!   lrschema.ksh - LIBERO code generation schema for Korn shell scripts      *
!                         Needs to translate state number -> name            *
!                                                                            *
!   Written:    95/03/06  Pieter Hintjens                                    *
!   Revised:    95/12/07                                                     *
!                                                                            *
!   Generates a script written in the Korn shell language (/bin/ksh).        *
!   Compatible with Eric Baalbergen's public domain ksh and Unix ksh.        *
!                                                                            *
...
function $"dialog_call"
{
    if [ $$LR_stack_size -lt $stack_max ]; then
        let LR_stack_size=$$LR_stack_size+1
